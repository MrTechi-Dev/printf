...
##|File|Description
---|---|---
1|[README.md](./README.md)|(printf/blob/master/README.md)...
2|[_printf.c - Function of our own printf ](./_printf.c)(printf/blob/master/_printf.c)|...
3|[printf_ops.c - Functios operator for each argument](printf/blob/master/printf_ops.c)|...
4|[printf_struct - Data Structure of our own printf function ](printf/blob/master/printf_struct.c)|...
5|[printf_valid - Conditions for validation the format of our own printf function ](/printf/blob/master/printf_valid.c)|...
6|[holberton.h - Our main library with the prototypes ](printf/blob/master/holberton.h)|...
7|[_putchar.c_ - Function that prints ASCII values ](.printf/blob/master/_putchar.c)|...
---
